...
r = Rectangle(4,2,"white")
print("\nRectangle Color:", r.getColor())
print("Rectangle Border Width:", r.getBorderWidth())
print("Rectangle Area:", r.area())

t = Triangle(4, 5, "green")
print("\nTriangle Color:", t.getColor())
print("Triangle Border Width:", t.getBorderWidth())
